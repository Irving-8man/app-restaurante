        ...
        <div class="menu">
          ...
          <ul>
            ...
            <li :class="{ 'active': $route.path === '/user/usermesascompletado' }">
              <router-link to="/user/usermesascompletado" style="color: rgb(0, 0, 0); font-weight: bold;">Mesas</router-link>
            </li>
      ...
      <div class="Mesas">
        <div class="rectangulo">
          ...
          <div class="Completado">
            <ul>
              <li :class="{ 'active': $route.path === '/user/usermesascompletado' }">
                <router-link to="/user/usermesascompletado" style="color: black; font-weight: bold;">Completado</router-link>
              </li>
            </ul>
          </div>
          <div class="Cancelado">
