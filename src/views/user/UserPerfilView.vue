...
button {
  ...
  color: white;
  width: 550px;
  padding: 10px; /* Agregado para espaciado interno */
  border: none;
  border-radius: 4px;
  cursor: pointer;
  white-space: nowrap; /* Evita el salto de línea en el texto */
  overflow: hidden; /* Oculta el contenido que excede el ancho especificado */
  text-overflow: ellipsis; /* Muestra puntos suspensivos (...) para el contenido que no cabe */
}
