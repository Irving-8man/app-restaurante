<template>
          ...
          <div class="Completado">
            <ul>
              <li :class="{ 'active': $route.path === '/user/userpedidosentregado' }">
                <router-link to="/user/userpedidosentregado" style="color: black; font-weight: bold;">Entregado</router-link>
              </li>
            </ul>
          </div>
        </div>
  ...
  .rectangulo li {
    text-align: center; /* Centra los textos de los elementos li */
  }
  .rectangulo p{
    margin-left: 15px;
  }
